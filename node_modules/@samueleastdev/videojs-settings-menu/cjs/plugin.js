...
var Button = _video.default.getComponent('MenuButton'); // Default options for the plugin.
...
var SettingsMenu = /*#__PURE__*/function (_Plugin) {
  (0, _inheritsLoose2.default)(SettingsMenu, _Plugin);
  ...
  function SettingsMenu(player, options) {
    ...
    _this.player.ready(function () {
      ...
      if (_video.default.browser.IS_IOS || _video.default.browser.IS_ANDROID) {
        _this.mobileBuildUI();
      }
  ...
  _proto.buildUI = function buildUI() {
    ...
    var SettingsMenuButton = /*#__PURE__*/function (_Button) {
      (0, _inheritsLoose2.default)(SettingsMenuButton, _Button);
    ...
    _video.default.registerComponent('settingsMenuButton', SettingsMenuButton);
  ...
  _proto.mobileBuildUI = function mobileBuildUI() {
    ...
    var SettingsMenuMobileModal = /*#__PURE__*/function (_Component) {
      (0, _inheritsLoose2.default)(SettingsMenuMobileModal, _Component);
    ...
    _video.default.registerComponent('settingsMenuMobileModal', SettingsMenuMobileModal);

    _video.default.dom.prependTo(self.player.addChild('settingsMenuMobileModal').el(), document.body);
  };
...
SettingsMenu.VERSION = _package.version; // Register the plugin with video.js.

_video.default.registerPlugin('settingsMenu', SettingsMenu);
